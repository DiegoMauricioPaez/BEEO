...
public final class FragmentAlertsBinding implements ViewBinding {
  ...
  private FragmentAlertsBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnMarkAllRead, @NonNull LinearLayout headerLayout,
      @NonNull RecyclerView rvAlerts, @NonNull TextView tvEmptyState) {
  ...
  public static FragmentAlertsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAlertsBinding((ConstraintLayout) rootView, btnMarkAllRead, headerLayout,
          rvAlerts, tvEmptyState);
    }
