...
public final class DaggerBEEOApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends BEEOApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(4).add(AlertsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(DashboardViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(MapViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(SettingsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
    ...
    private SplashActivity injectSplashActivity2(SplashActivity instance) {
      SplashActivity_MembersInjector.injectPrefsRepository(instance, singletonCImpl.provideUserPreferencesRepositoryProvider.get());
      return instance;
    }
  }
  ...
  private static final class ViewModelCImpl extends BEEOApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(4).put("com.beeo.app.presentation.notifications.AlertsViewModel", ((Provider) alertsViewModelProvider)).put("com.beeo.app.presentation.dashboard.DashboardViewModel", ((Provider) dashboardViewModelProvider)).put("com.beeo.app.presentation.map.MapViewModel", ((Provider) mapViewModelProvider)).put("com.beeo.app.presentation.settings.SettingsViewModel", ((Provider) settingsViewModelProvider)).build();
    }
  ...
  private static final class SingletonCImpl extends BEEOApplication_HiltComponents.SingletonC {
    ...
    private Map<String, javax.inject.Provider<WorkerAssistedFactory<? extends ListenableWorker>>> mapOfStringAndProviderOfWorkerAssistedFactoryOf(
      ...
      return Collections.<String, javax.inject.Provider<WorkerAssistedFactory<? extends ListenableWorker>>>singletonMap("com.beeo.app.service.DailySummaryWorker", ((Provider) dailySummaryWorker_AssistedFactoryProvider));
    }
